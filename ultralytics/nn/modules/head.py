...
class Pose(Detect):
    ...
    def forward(self, x,compute_pose:bool=True):
        ...
        if self.compute_pose :
            ...
            return torch.cat([y, pred_kpt], 1) if self.export else (torch.cat([y[0], pred_kpt], 1), (x[1], kpt))
        else:
            return Detect.forward(self, x)
